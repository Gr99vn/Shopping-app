document.addEventListener("DOMContentLoaded", () => {
	...
	btnMinus.addEventListener("click", (e) => {
	    ...
	    document.querySelector(".temp-total").innerHTML = "Tạm tính: " + formatNumber(document.querySelector(".temp-total").dataset.price * document.querySelector("#quantity").value) + " VND";
	});
